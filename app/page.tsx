...
export default function Home() {
  ...
  // Fonction de génération et téléchargement automatique du reçu PDF avec les numéros officiels et détails de livraison
  const generatePDFReceipt = (orderData: any) => {
    ...
    // Ajout des numéros de contact sur le reçu PDF
  ...
  return (
    <div className="min-h-screen bg-[#090A0C] text-slate-100 font-sans relative">
      ...
      <section id="contact" className="py-24 px-6 max-w-7xl mx-auto border-t border-[#D4AF37]/20">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-slate-400 max-w-xl mx-auto text-lg">
            Une question sur nos services, un projet immobilier ou une opportunité de partenariat ? Écrivez-nous.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="space-y-6">
            <div className="p-6 rounded-2xl bg-slate-900/60 border border-[#D4AF37]/30 space-y-3 backdrop-blur-sm">
              <h4 className="text-white font-bold">Siège Principal (Bénin)</h4>
              <p className="text-slate-400 text-sm">Abomey-Calavi, Bénin</p>
              <p className="text-[#D4AF37] font-semibold text-sm">+229 01 69 32 55 76</p>
            </div>
            <div className="p-6 rounded-2xl bg-slate-900/60 border border-[#D4AF37]/30 space-y-3 backdrop-blur-sm">
              <h4 className="text-white font-bold">Représentation Côte d'Ivoire</h4>
              <p className="text-slate-400 text-sm">Abidjan, Côte d'Ivoire</p>
              <p className="text-[#D4AF37] font-semibold text-sm">+225 07 104 106 04</p>
            </div>
          </div>

          <div className="lg:col-span-2 p-8 rounded-3xl bg-slate-950 border border-[#D4AF37]/30 shadow-2xl">
            {contactSubmitted && (
              <div className="mb-6 p-4 rounded-xl bg-emerald-950/80 border border-emerald-500 text-emerald-200 text-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Négoce">Négoce & E-commerce</option>
      ...
      {/* Footer */}
      <footer className="bg-slate-950 border-t border-[#D4AF37]/20 py-12 px-6 text-center text-slate-400 text-sm space-y-4">
        <p>© {new Date().getFullYear()} SAB MIDLEY. Tous droits réservés. Présent au Bénin, en Côte d'Ivoire et au Burkina Faso.</p>
        <div className="flex justify-center space-x-6 text-xs text-slate-500">
          <span>Tél BJ : +229 01 69 32 55 76</span>
          <span>Tél CI : +225 07 104 106 04</span>
          <span>Tél BF : +226 04 26 18 02</span>
          <span>Tél TG : +228 92 04 66 86</span>
        </div>
      </footer>

      {/* ================= BOUTON RETOUR EN HAUT (TOP UP) ================= */}
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 z-50 p-3.5 rounded-full bg-[#D4AF37] text-[#090A0C] font-bold shadow-2xl hover:bg-[#c5a030] transition-all transform hover:scale-110 flex items-center justify-center border border-white/20"
